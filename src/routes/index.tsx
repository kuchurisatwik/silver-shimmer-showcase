  ...
  head: () => ({
    meta: [
      { title: "Vineeth Silver Jewellery — Timeless Silver, Rooted in Elegance" },
      {
        name: "description",
        content:
          "A modern atelier of hand-crafted silver jewellery. Limited collections, cinematic craftsmanship, quiet luxury.",
      },
      { property: "og:title", content: "Vineeth Silver Jewellery" },
      {
        property: "og:description",
        content: "Modern silver, hand-finished. Timeless pieces from the Vineeth atelier.",
      },
