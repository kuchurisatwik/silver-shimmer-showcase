          ...
          <div className="col-span-12 lg:col-span-5 reveal" style={{ transitionDelay: "150ms" }}>
            ...
            <div className="space-y-5 text-[15px] leading-[1.9]" style={{ color: "var(--muted-foreground)" }}>
              ...
              <p>
                ...
                We believe that true luxury is unhurried. It takes time to cast, time to polish, time to inspect. That is why every
                Vineeth piece leaves the atelier ready to become a masterpiece.
              </p>
            </div>
