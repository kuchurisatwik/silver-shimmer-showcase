...
const cats = [
  {
    ...
    desc: "Sculptural silhouettes — from delicate everyday chains to bold modern collars finished by hand.",
    img: pick(1),
    count: "67 pieces",
  },
  {
  ...
  },
  {
    ...
    desc: "Modern silhouettes for the moments that ask to be remembered — and the ones that will be.",
    img: pick(17),
    count: "18 pieces",
  },
  {
